...
\leftheader{%
  {\LARGE\bfseries\sffamily Taisho Sasada, Master.}

  \makefield{\faEnvelope[regular]}{\texttt{sasada.taisho.su0@is.naist.jp}}\\
  \makefield{\faTwitter}{\texttt{ts\_rx1182}}\\
  \makefield{\faGlobe}{\url{https://scholar.google.com/citations?hl=en&user=Orh0RxAAAAAJ}}\\
